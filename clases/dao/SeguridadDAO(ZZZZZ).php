...
class SeguridadzzzzzDAO{  
      ...
      function ConsultarurlDAO($url,$tipo){
       ...
       $sql="SELECT * from seguridad.t02_menu as a,seguridad.t03_perfil as b
           ...
           a.c_pagina='".$url."' and b.c_tipo='".$tipo."' and a.cid_t01_sistema=22;";
      //die($sql); 
...
function AgregaripDAO($txtFuncion){
   ...
   VALUES (NEXTVAL('seguridad.t04_ip_cid_t04_ip_seq'),21,".$_SESSION['idusuario'].", 
